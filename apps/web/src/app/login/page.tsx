        ...
        <AuthLayout>
            ...
            <div className="mt-8 flex flex-col items-center gap-4">
                <div className="flex items-center gap-4 w-full">
                    ...
                    <span className="text-xs text-slate-500 uppercase tracking-widest font-medium">Ou entre com</span>
                    <div className="h-[1px] bg-white/5 flex-1" />
                </div>

                <button className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium py-3 rounded-2xl transition-all flex items-center justify-center gap-3">
